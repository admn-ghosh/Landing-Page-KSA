...
const WhatsAppCTA: React.FC = () => {
  ...
  const fabPositionClass = language === 'ar' ? 'rtl' : 'ltr';

  return (
    <a
      href="https://wa.me/966551253386?text=Hello%2C%20I%27m%20interested%20in%20your%20sandwich%20panels%20for%20a%20project%20in%20Saudi%20Arabia."
      className={`whatsapp-fab ${fabPositionClass} animate-heartbeat`}
      target="_blank"
